...
url = 'https://kr.noxinfluencer.com/youtube-channel-rank/top-250-vn-all-youtuber-sorted-by-growth-weekly'
...
def rhot():
    ...
    gains = soup.select('.followerNum .change up .change-num')
    gain_list = []
    for gain in gains:
        gain_list.append(gain.get_text())
    # print(gain_list)
